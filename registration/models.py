...
def custom_upload_to(instance, filename):
    ...
    return 'profiles/' + "user-db-id-" + str(old_instance.user.id) + pathlib.Path(filename).suffix # Guardamos la nueva foto en la carpeta que le asignemos, junto al nommbre del archivo
