...
class ProfileForm(forms.ModelForm):
    class Meta:
        model = Profile
        fields = ['avatar', 'bio', 'link', 'facebook_url','twitter_url', 'instagram_url', 'tiktok_url']
        widgets = {
            'avatar': forms.ClearableFileInput(attrs={'class':'form-control-file mt-3'}),
            'bio': forms.Textarea(attrs={'class':'form-control mt-3', 'rows':3, 'placeholder':'Biografia'}),
            'link': forms.URLInput(attrs={'class':'form-control mt-3', 'placeholder':'Enlace'}),
            'facebook_url': forms.URLInput(attrs={'class':'form-control mt-3', 'placeholder':'Perfil Facebook'}),
            'twitter_url': forms.URLInput(attrs={'class':'form-control mt-3', 'placeholder':'Perfil Twitter'}),
            'instagram_url': forms.URLInput(attrs={'class':'form-control mt-3', 'placeholder':'Perfil Instagram'}),
            'tiktok_url': forms.URLInput(attrs={'class':'form-control mt-3', 'placeholder':'Perfil Tiktok'}),
        }
